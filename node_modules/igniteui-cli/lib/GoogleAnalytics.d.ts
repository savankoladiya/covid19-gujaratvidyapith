declare class GoogleAnalytics {
    protected static userDataFolder: string;
    protected static appFolder: string;
    protected static userSettings: string;
    protected static appVersion: string;
    protected static npmVersion: string;
    protected static trackingID: string;
    /**
     ...
     */
    static post(parameters: GoogleAnalyticsParameters): void;
    protected static getUUID(): string;
    protected static getUserID(): string;
    protected static getMachineID(platform: string, result: string): string;
