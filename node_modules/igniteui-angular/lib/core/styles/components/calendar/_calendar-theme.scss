...
@function igx-calendar-theme(
    ...
    @return extend($theme, (
        ...
        picker-text-hover-color: #0000FF,
        ...
        year-hover-text-color: #0000FF,
        month-hover-text-color: #0000FF,
        month-hover-background: #ffffff,

        date-selected-background:#ffffff,
        date-selected-text-color: #0000FF,
...
@mixin igx-calendar($theme) {
    ...
    $cal-header-padding: em(3px);

    $cal-picker-padding: em(1px);
    ...
    $cal-value-month-margin: 0 em(1px);
    $cal-value-month-height: em(32px);

    $cal-row-padding: 1px;
    $cal-row-margin: em(3px) 0;
